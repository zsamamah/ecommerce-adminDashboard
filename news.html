                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item">
                             ...
                             <li class="nav-item">
                               <button class="btn btn-outline-success">ADD NEWS</button>
                            </li>
                            <li class="nav-item">
                ...
                <div class="card-body">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">1</th>
                                <td>Unique Women's Accessories Trend that Will Popular ...</td>
                                <td>PUBLISHED</td>
                                <td>NORMAL</td>
                                <td>08 Feb 17</td>
                            ...
                            <tr>
                                <th scope="row">2</th>
                                <td>We Join Smartphone Fair in Washington, D.C. April ...</td>
                                <td>PUBLISHED</td>
                                <td>NORMAL</td>
                                <td>08 Feb 17</td>
                                <td><button class="no-border"><i class="material-icons down">more_vert</i></button></td>
